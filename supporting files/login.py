...
def login():
    ...
    if st.button("Login"):
        if username == "user" and password == "123":  # User login credentials
            st.success("User Logged in successfully!")
            return "user"
        elif username == "admin" and password == "123":  # Admin login credentials
...
# Function to display live video stream for admin
